<?php
    ...
    {
        logAdminActivity($_SESSION['admin_id_barbershop_Xw211qAAsq4'], 'Opened Employees Dashboard');
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            foreach($rows_employees as $employee) {
                                                ...
                                                echo "</td>";
                                                echo "<td>";
                                                // Add maxlength attribute to the phone number cell
                                                echo '<span data-toggle="tooltip" title="' . $employee['phone_number'] . '">';
                                                echo substr($employee['phone_number'], 0, 11); // Display only the first 11 digits
                                                echo '</span>';
                                                echo "</td>";
                                                echo "<td>";
                                                echo $employee['email'];
