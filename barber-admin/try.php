        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header tab" style="padding: 0px !important;background: #36b9cc!important">
                    ...
                    <button class="tablinks active" onclick="openTab(event, 'Ongoing')">
                        Ongoing Bookings
                    </button>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <!-- Upcoming Bookings -->
                        <table class="table table-bordered tabcontent" id="Upcoming" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>
                                        Start Time
                            ...
                            <?php
                                ...
                                if ($count == 0) {
                                    ...
                                    foreach ($rows as $row) {
                                        ...
                                        echo "<td>";
                                        // No cancel button for finished appointments
                                        echo "Finished";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
