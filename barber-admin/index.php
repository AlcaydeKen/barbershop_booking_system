<?php 
    ...
    if(isset($_SESSION['username_barbershop_Xw211qAAsq4']) && isset($_SESSION['password_barbershop_Xw211qAAsq4']))
    {
        ...
        logAdminActivity($_SESSION['admin_id_barbershop_Xw211qAAsq4'], 'Opened Main Dashboard');
?>
        <!-- Begin Page Content -->
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header tab" style="padding: 0px !important;background: #36b9cc!important">
                    ...
                    <button class="tablinks" onclick="openTab(event, 'Ongoing')">
                        Ongoing Bookings
                    </button>

                    <button class="tablinks" onclick="openTab(event, 'Finished')">
                        Finished Bookings
                    </button>
                    ...
                    <button class="tablinks" onclick="openTab(event, 'All')">
                        All Bookings
                    <button class="tablinks" onclick="openTab(event, 'Suggestions')">
                        Suggestions
                    </button>
                </div>
                <div class="card-body">
                    ...
                    <!-- Suggestions -->
                    <table class="table table-bordered tabcontent" id="Suggestions" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>
                                        Name
                            ...
                            <tbody>
                            <?php
                                    if(isset($rows_messages) && is_array($rows_messages)) {
                                        foreach($rows_messages as $messages) {
                                            echo "<tr>";
                                            echo "<td>";
                                            echo $messages['Name'];
                                            echo "</td>";
                                        ...
                                        <ul class="list-inline m-0">
                                            ...
                                            <li class="list-inline-item" data-toggle="tooltip" title="Cancel Appointment">
                                                <button class="btn btn-danger btn-sm rounded-0" type="button" data-toggle="modal"
                                                        data-target="#<?php echo $cancel_data; ?>" data-placement="top">
                                                    <i class="fas fa-calendar-times"></i>
                                                </button>

                                                <!-- CANCEL MODAL -->
                                                <div class="modal fade" id="<?php echo $cancel_data; ?>" tabindex="-1" role="dialog"
                                                    aria-labelledby="<?php echo $cancel_data; ?>" aria-hidden="true">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control"
                                                                            id=<?php echo "appointment_cancellation_reason_" . $row['appointment_id'] ?>></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                                                                <button type="button" data-id="<?php echo $row['appointment_id']; ?>"
                                                                        class="btn btn-danger cancel_appointment_button">Yes, Cancel
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <!-- Ongoing Bookings -->
                        <table class="table table-bordered tabcontent" id="Ongoing" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>
                                        Start Time
                            ...
                            <tbody>
                                ...
                                $stmt = $con->prepare("SELECT * 
                                                        FROM appointments a , clients c
                                                        WHERE start_time <= NOW() AND end_time_expected >= NOW()
                                                        AND a.client_id = c.client_id
                                                        AND canceled = 0
                                                        ORDER BY start_time;");
                                $stmt->execute();
                                ...
                                if ($count == 0) {
                                    echo "<tr>";
                                    echo "<td colspan='5' style='text-align:center;'>";
                                    echo "No ongoing appointments at the moment.";
                                    echo "</td>";
                                    echo "</tr>";
                                } else {
                                    foreach ($rows as $row) {
                        ...
                        <!-- Finished Bookings -->
                        <table class="table table-bordered tabcontent" id="Finished" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>
                                        Start Time
                            ...
                            <?php
                                $stmt = $con->prepare("SELECT * 
                                                        FROM appointments a , clients c
                                                        WHERE start_time <= NOW()  -- Fetch finished appointments
                                                        AND end_time_expected <= NOW() 
                                                        AND a.client_id = c.client_id
                                                        AND canceled = 0
                                                        ORDER BY start_time;");
                                $stmt->execute();
                                ...
                                if ($count == 0) {
                                    echo "<tr>";
                                    echo "<td colspan='5' style='text-align:center;'>";
                                    echo "List of your finished bookings will be presented here";
                                    echo "</td>";
                                    echo "</tr>";
                                } else {
                                    foreach ($rows as $row) {
